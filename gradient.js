const canvas = document.getElementById('gradientCanvas');
        ...
        const fragmentShaderSource = `
            ...
            {
                // Константа пикселизации (0 - без пикселизации)
                const int ps = 0;
                ...
                // Преобразуем в фиолетовую палитру
                vec3 col = vec3(
                    cl1 * 0.3 + c2 * 0.1,    // R - уменьшаем красный
                    c3 * 0.1 + cl1 * 0.05,   // G - минимум зеленого
                    cl1 * 0.6 + c2 * 0.4 + c3 * 0.3  // B - акцент на синий
                );
                
                // Усиливаем фиолетовые тона
                col = mix(col, vec3(0.15, 0.05, 0.25), 0.4);
                
                // Делаем темнее и повышаем насыщенность
